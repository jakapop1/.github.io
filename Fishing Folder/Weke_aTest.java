...
/**
* JUnit test for Weke_a I'a subclass.
* @author Lisa Miller
* @since 3/15/22
*/
...
public class Weke_aTest {
   ...
   */
   ...
   @Test public void constructorAndGetterTest(){
      ...
      Assert.assertTrue("Name is not correct. It is " + name + " but should be Weke'a",
             name.equalsIgnoreCase("Weke'a"));
      Assert.assertTrue("English name is not correct. It is " + engName + " but should be Square-spot Goatfish",
             engName.equalsIgnoreCase("Square-spot Goatfish"));
      Assert.assertTrue("Scientific name is not correct. It is " + sciName 
            + " but should be Mulloidichthys flavolineatus",
      ...
      Assert.assertTrue("Body color is not correct. It is " + bodColor 
            + " but should be white with yellow stripe and black spot", 
            bodColor.equalsIgnoreCase("white with yellow stripe and black spot"));
      Assert.assertTrue("Fin color is not correct. It is " + finColor + " but should be white", 
            finColor.equalsIgnoreCase("white"));
...
//              sciName.equalsIgnoreCase("Mulloidichthys flavolineatus"));
   ...
   public void constructorLengthTooLongTest(){
      I_a i = new Weke_a(33.1);
   }

     /** Constructor with length Exception test.*/
   @Test(expected=FishSizeException.class)
   public void constructorLengthTooShortTest(){
      I_a i = new Weke_a(-0.1);
   }
...
//   } //end level up test
  ...
  * This size weke can change color mayber should throw exception if tried to turn red.
  */
  @Test public void setColorMethodTest() {
    Weke_a a = new Weke_a();
      a.setColor("white", "white");
